  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <br />
        <input  className="inputs" name="password" type="password" placeholder="Password" required />
        <br />
        <p className="resetpass"onClick={handleReset}>Forgot Password?</p>
        <br />
        {errorMessage && <p style={{ color: "red" }}>{errorMessage}</p>}
        <button className="signupbtn" type="submit">{isSignIn ? "Sign In" : "Sign Up"}</button>
      </form>
      </div>
    </div>
  );
